...
func Context(
	...
	providerRegistries ...adapter.ProviderRegistry,
) context.Context {
	var providerRegistry adapter.ProviderRegistry = provider.NewRegistry()
	if len(providerRegistries) > 0 && providerRegistries[0] != nil {
